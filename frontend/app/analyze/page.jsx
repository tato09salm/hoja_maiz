  ...
  return (
    <ProtectedLayout>
      <div className="p-4 md:p-6">
        <div className="mb-4">
          <h1 className="text-2xl font-bold text-gray-800">Analizar Hoja de Maíz</h1>
          <p className="text-gray-500 mt-1 text-sm">Sube una foto o usa la cámara para analizar la salud de tu hoja</p>
        </div>

        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4 md:p-5">
          <div className="mb-4">
            <h2 className="text-lg font-semibold text-gray-800 mb-3">Imagen de la Hoja</h2>

            {!showCamera && (
              <div className="flex flex-wrap gap-2 mb-3">
                <label className="px-3 py-2 border border-green-600 text-green-600 rounded-md font-medium hover:bg-green-50 cursor-pointer flex items-center gap-2 text-sm">
                  <Upload size={18} />
                  <input
                    type="file"
            ...
            {showCamera && (
              <div className="mb-3">
                ...
                <div className="flex justify-center gap-2 mt-3">
                  ...
                  <button
                    onClick={stopCamera}
                    className="px-5 py-2 border border-gray-400 text-gray-700 rounded-md font-medium hover:bg-gray-50 text-sm"
                  >
                    Cancelar
                  </button>
                </div>
          ...
          {result && (
            <div className="border-t border-gray-200 pt-4">
              <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-4">
                <h2 className="text-lg font-semibold text-gray-800">Resultados del Análisis</h2>
                {result.is_corn_leaf && (
                  <button
                    onClick={generatePDF}
              ...
              {!result.is_corn_leaf ? (
                <div className="p-4 rounded-lg border border-yellow-500 bg-yellow-50 text-center">
                  <div className="text-3xl mb-2">⚠️</div>
                  <h3 className="text-lg font-bold text-yellow-800 mb-1">Imagen no válida</h3>
                  <p className="text-yellow-700 mb-3 text-sm">{result.validation_message}</p>
                  <p className="text-xs text-gray-600 italic">Por favor, sube una imagen clara de una hoja de maíz.</p>
                </div>
              ) : (
                <>
                  ...
                  <div className="mb-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                      {Object.entries(result.class_probabilities).map(([className, prob]) => (
                        <div key={className} className="flex items-center gap-2 bg-gray-50 p-3 rounded-md">
                          <div className="flex-1">
                            <div className="flex justify-between text-xs mb-1">
                              <span className="font-medium">{className}</span>
                              <span className="font-bold">{(prob * 100).toFixed(0)}%</span>
                            </div>
